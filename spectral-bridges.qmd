...
The python scripts to reproduce the simulations are available at <https://github.com/flheight/Spectral-Bridges>. 

A R package implementing the algorithm is also available (<https://github.com/cambroise/spectral-bridges>).
