...
We set the hyperparameters of our algorithm based on the size of each dataset, $n$, and the number of clusters, $K$. Choosing the number of Voronoi regions to be approximately $m\approx \frac{n}{K}$  provides a reasonable trade-off.
