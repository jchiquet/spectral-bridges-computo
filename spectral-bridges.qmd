...
The Spectral Bridge algorithm is implemented both in Python (<https://github.com/flheight/Spectral-Bridges>) and R <https://github.com/cambroise/spectral-bridges>).
...
Numerical experiments have been conducted in Python. The python scripts to reproduce the simulations and figures are available at <https://github.com/flheight/Spectral-Bridges>. A R package implementing the algorithm is also available (<https://github.com/cambroise/spectral-bridges>).
