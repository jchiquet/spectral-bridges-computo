...
By adjusting $m$ in this manner, we aim to balance the need for detailed representation with the risk of overfitting, ensuring that each Voronoï region meaningfully captures the underlying data distribution.
...
\Comment{$\text{voronoiRegions}$: array of $m$ Voronoï regions, $\text{centroids}$: the centers of each region}
